                        ...
                        <?php
                            ...
                            $conn = mysqli_connect('localhost','root','','chappy_db');
                                ...
                                if(isset($_GET['search-order']))
                                {
                                    ...
                                    $query = "SELECT * FROM order_form WHERE CONCAT(order_id, payer_name, shape, size, material, qty, processing, payment_total_amount, status, date_order) LIKE '%$filtervalue%' && status = 'Cancelled by admin' ";
